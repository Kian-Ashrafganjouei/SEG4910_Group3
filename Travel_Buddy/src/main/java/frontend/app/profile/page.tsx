          ...
          <div className="form-container">
            ...
            <div className="checkbox-group">
                ...
                <label key={language} className="checkbox-label">
                    <input
                    type="checkbox"
                    checked={Array.isArray(userData?.languages) && userData?.languages.includes(language)}
                    onChange={(e) => {
                        const isChecked = e.target.checked;

                        // Ensure that userData.languages is an array
                        const currentLanguages = Array.isArray(userData?.languages)
                        ? userData?.languages
                        : [];
            ...
            <div className="checkbox-group">
                ...
                <label key={interest} className="checkbox-label">
                    <input
                    type="checkbox"
                    checked={Array.isArray(userData?.interests) && userData?.interests.includes(interest)}
                    onChange={(e) => {
                        const isChecked = e.target.checked;
                        ...
                        : currentInterests.filter((lang) => lang !== interest);
